        ...
        const fetchData = async () => {
            try {
                ...
                const [
                    ...
                    fetch("http://localhost:5000/api/status-pengiriman").then(r => r.json()),
                    fetch("http://localhost:5000/api/status-permintaan").then(r => r.json()),
                ]);
                        ...
                        {!trackingStatus.BKB ? (
                            <Card className="border-dashed border-2 shadow-none bg-slate-50/50">
                                <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                                    ...
                                    <p className="text-sm text-slate-500 max-w-sm mt-1">Barang belum dikeluarkan dari gudang ke toko.</p>
                                </CardContent>
                            </Card>
                        ) : (
                            <Card className="border-none shadow-md bg-white overflow-hidden ring-1 ring-slate-900/5 transition-all hover:shadow-lg">
