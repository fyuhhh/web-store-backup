...
async function runDebug() {
    try {
        ...
        const resList = await fetch('http://192.168.10.10:5000/api/pr');
        ...
        // Fetch valid satuan
        const resSatuan = await fetch('http://192.168.10.10:5000/api/satuan');
        ...
        const resItems = await fetch("http://192.168.10.10:5000/api/pr-item");
        ...
        const resPut = await fetch(`http://192.168.10.10:5000/api/pr/${prId}`, {
            method: 'PUT',
        ...
        const resItems2 = await fetch("http://192.168.10.10:5000/api/pr-item");
